...
/**
 * VehicleAreaDoor is an abstraction for a door in a car. Some car APIs may provide control per door
 * and values defined here should be used to distinguish different doors.
 *
 * <p>Source: <a
 * href="https://android.googlesource.com/platform/packages/services/Car/+/refs/heads/android16-release/car-lib/src/android/car/VehicleAreaDoor.java">VehicleAreaDoor</a>
 */
